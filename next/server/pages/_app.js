...
// EXTERNAL MODULE: ./src/@core/store/userStore.js
var userStore = __webpack_require__(8660);
...
const UserDropdown = ()=>{
    ...
    const logout = (0,userStore/* useUserStore */.L)((state)=>state.logout
    );
    const details = (0,userStore/* useUserStore */.L)((state)=>state.details
    );
    // ** Hooks
    const router = (0,router_.useRouter)();
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)((Box_default()), {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0,jsx_runtime_.jsxs)((Typography_default()), {
                                            ...
                                            children: [
                                                details === null || details === void 0 ? void 0 : details.name,
                                                " "
                                            ]
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx((Typography_default()), {
...
;// CONCATENATED MODULE: ./src/@core/components/AuthContent.js
...
function AuthContent({ children  }) {
    const router = (0,router_.useRouter)();
    const isAuthenticated = (0,userStore/* useUserStore */.L)((state)=>state.isAuthenticated
    );
...
const UserLayout = ({ children  })=>{
    ...
    const { role  } = details;
    const getRole = ()=>{
        if ((role === null || role === void 0 ? void 0 : role.superAdmin) === "Yes") {
            return SuperNavigation();
        }
        if ((role === null || role === void 0 ? void 0 : role.admin) === "Yes") {
    ...
    return(/*#__PURE__*/ jsx_runtime_.jsx(layouts_VerticalLayout, {
        ...
        settings: settings,
        saveSettings: saveSettings,
        verticalNavItems: getRole(),
        afterVerticalNavMenuContent: true,
        ...
        ,
        children: /*#__PURE__*/ jsx_runtime_.jsx(AuthContent, {
            children: children
        })
    }));
};
...
// EXTERNAL MODULE: ./src/@core/store/alertSlice.js
var alertSlice = __webpack_require__(8016);
...
const App = (props)=>{
    ...
    const message = (0,alertSlice/* AlertStore */.q)((state)=>state.message
    );
    const messageStatus = (0,alertSlice/* AlertStore */.q)((state)=>state.messageStatus
    );
    const messageType = (0,alertSlice/* AlertStore */.q)((state)=>state.messageType
    );
    const setMessage = (0,alertSlice/* AlertStore */.q)((state)=>state.setMessage
    );
    const setStatus = (0,alertSlice/* AlertStore */.q)((state)=>state.setStatus
    );
    const setType = (0,alertSlice/* AlertStore */.q)((state)=>state.setType
    );
    (0,external_react_.useEffect)(()=>{
        if (messageStatus) {
            (0,external_react_toastify_.toast)(message, {
                type: messageType
            });
            setStatus(false);
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,415,745], () => (__webpack_exec__(33)));
